	...
	<footer role="contentinfo" class="footer">
		<div class="footer-content">
			<div class="container">
				<div class="row">
					...
					<div class="col-6 col-md-3">
						<h4>Game Improvement Videos</h4>
						<ul>
							<li>
								<a href="/videos">Fundamentals</a>
							</li>
							<li>
								<a href="/videos">Driver</a>
							</li>
							<li>
								<a href="/videos">Irons</a>
							</li>
							<li>
								<a href="/videos">Wedges</a>
							</li>
							<li>
								<a href="/videos">Chipping</a>
							</li>
							<li>
								<a href="/videos">Putting</a>
							</li>
						</ul>
					</div>
					<div class="col-6 col-md-3">
						...
						<ul>
							<li>
								<a href="/store">Equipment</a>
							</li>
							<li>
								<a href="/store">Accessories</a>
							</li>
							<li>
								<a href="/signup">Swingbits Membership</a>
							</li>
							<li>
								<a href="/videos">Instruction</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="container-fluid footer-bottom">
			<div class="float-left">
				TM + &#9400;
				<?php echo date("Y"); ?> Swingbits, LLC. All rights reserved.
				<a href="" data-toggle="modal" data-target="#termsModal">Terms</a> |
				<a href="" data-toggle="modal" data-target="#privacyModal">Privacy</a> | Made with
				<img src="<?php echo get_bloginfo( 'template_directory' ); ?>/img/heart.png" alt=""> in Nevada.
			</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h2>Welcome to Swingbits</h2>
					<p>These terms and conditions outline the rules and regulations for the use of Swingbits's Website.</p>
					<br />
					<span style="text-transform: capitalize;"> Swingbits</span> is located at:
					<br />
					<address>1234 Change This , Las Vegas
						<br />NV - 99999, United States
						<br />
					</address>
					<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Swingbits's
					...
					<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or
						...
						subject to, prevailing law of United States. Any use of the above terminology or other words in the singular, plural,
						capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
					<h2>Cookies</h2>
					<p>We employ the use of cookies. By using Swingbits's website you consent to the use of cookies in accordance with Swingbits’s
						privacy policy.</p>
					...
					<h2>License</h2>
					<p>Unless otherwise stated, Swingbits and/or it’s licensors own the intellectual property rights for all material on Swingbits.
						All intellectual property rights are reserved. You may view and/or print pages from https://www.swingbits.com for your
						own personal use subject to restrictions set in these terms and conditions.</p>
					<p>You must not:</p>
					<ol>
						<li>Republish material from https://www.swingbits.com</li>
						<li>Sell, rent or sub-license material from https://www.swingbits.com</li>
						<li>Reproduce, duplicate or copy material from https://www.swingbits.com</li>
					</ol>
					<p>Redistribute content from Swingbits (unless content is specifically made for redistribution).</p>
					...
					<ol>
						<li>The following organizations may link to our Web site without prior written approval:
							<ol>
								...
								<li>Online directory distributors when they list us in the directory may link to our Web site in the same manner as they
					...
					<ol start="2">
						<li>These organizations may link to our home page, to publications or to other Web site information so long as the link:
					...
					<p>These organizations may link to our home page, to publications or to other Web site information so long as the link:
						(a) is not in any way misleading; (b) does not falsely imply sponsorship, endorsement or approval of the linking party
						and it products or services; and (c) fits within the context of the linking party's site.
					</p>
					...
					<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must
						...
						<a href="mailto:support@swingbits.com" title="send an email to support@swingbits.com">support@swingbits.com</a>. Please include your name, your organization name, contact information (such as a phone number
						and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web
						site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
					...
					<p>No use of Swingbits’s logo or other artwork will be allowed for linking absent a trademark license agreement.
					</p>
					<h2>Iframes</h2>
					...
					<p>We reserve the right at any time and in its sole discretion to request that you remove all links or any particular link
						...
						to amend these terms and conditions and its linking policy at any time. By continuing to link to our Web site, you
						agree to be bound to and abide by these linking terms and conditions.</p>
					<h2>Removal of links from our website</h2>
					<p>If you find any link on our Web site or any linked web site objectionable for any reason, you may contact us about this.
					...
					<p>We shall have no responsibility or liability for any content appearing on your Web site. You agree to indemnify and
						...
						site or within any context containing content or materials that may be interpreted as libelous, obscene or criminal,
						or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>
					<h2>Disclaimer</h2>
					...
					<p>This Terms and conditions page was created at
						<a style="color:inherit;text-decoration:none;cursor:text;" href="https://termsandconditionstemplate.com">termsandconditionstemplate.com</a> generator. If you have any queries regarding any of our terms, please contact us.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>Swingbits LLC ("us", "we", or "our") operates the https://www.swingbits.com website (the "Service").</p>
					...
					<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information
						in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy
						have the same meanings as in our Terms and Conditions, accessible from https://www.swingbits.com</p>
					...
					<p>Swingbits LLC uses the collected data for various purposes:</p>
					<ul>
					...
					<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
						transfer.</p>
					<p>Swingbits LLC will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
					...
					<p>Swingbits LLC may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
					<ul>
						<li>To comply with a legal obligation</li>
						<li>To protect and defend the rights or property of Swingbits LLC</li>
					...
					<ul>
						...
						<li>
							...
							<p>Clicky is a web analytics service. Read the Privacy Policy for Clicky here:
					...
					<ul>
						<li>By email: support@swingbits.com</li>
